...
import random
import graphene
from logicPlayer import Player
...
class Game():
    ...
    def __init__(self, numPlayers, humanPlayer=False):
        ...
        for i in range(0, numPlayers):
            if i == 0:
                ...
                self.playArray.append(NNPlayer(self.fact, newMod=True, weightMod=weightMod))
            elif humanPlayer:
    ...
    def endGame(self):
        ...
        self.gameWinner = max(bestPlayer.items(), key=operator.itemgetter(1))[0]
